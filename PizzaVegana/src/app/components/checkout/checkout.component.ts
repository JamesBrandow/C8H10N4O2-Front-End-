...
export class CheckoutComponent implements OnInit {
  ...
  ngOnInit(): void {
    console.log(this.totalTicketPrice);
    this.ticketservice.theTicket.pizzas.forEach(pizza =>{
      this.ticketservice.theTicket.cost = this.ticketservice.theTicket.cost + pizza.price.valueOf();
      console.log("Each pizza cost",pizza.price);
    });
